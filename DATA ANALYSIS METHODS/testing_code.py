...
VAF = 100 * (1 - (np.var(Y_test - y_pred_knn) / np.var(Y_test)))
print("VAF: ",VAF)
...
VAF = 100 * (1 - (np.var(Y_test - y_pred_extra_trees) / np.var(Y_test)))
print("VAF: ",VAF)
nse_lr = 1 - ( np.sum((Y_test - y_pred_extra_trees)**2) / np.sum((Y_test - mean_observed)**2))
print("NSE: ",nse_lr)
...
VAF = 100 * (1 - (np.var(Y_test - y_pred_bagging) / np.var(Y_test)))
print("VAF: ",VAF)
nse_lr = 1 - ( np.sum((Y_test - y_pred_bagging)**2) / np.sum((Y_test - mean_observed)**2))
print("NSE: ",nse_lr)
...
VAF = 100 * (1 - (np.var(Y_test - y_pred_adaboost) / np.var(Y_test)))
print("VAF: ",VAF)
nse_lr = 1 - ( np.sum((Y_test - y_pred_adaboost)**2) / np.sum((Y_test - mean_observed)**2))
print("NSE: ",nse_lr)
...
print("VAF: ",VAF)
nse_lr = 1 - ( np.sum((Y_test - y_pred)**2) / np.sum((Y_test - mean_observed)**2))
print("NSE: ",nse_lr)
...
print('SD: ',std_lr)
VAF = 100 * (1 - (np.var(Y_test - Y_pred_LR) / np.var(Y_test)))
print("VAF: ",VAF)
...
print('SD: ',std_rf)
VAF = 100 * (1 - (np.var(Y_test - Y_pred_RF) / np.var(Y_test)))
print("VAF: ",VAF)
nse_lr = 1 - ( np.sum((Y_test - Y_pred_RF)**2) / np.sum((Y_test - mean_observed)**2))
print("NSE: ",nse_lr)
...
print('SD: ',std_dt)
VAF = 100 * (1 - (np.var(Y_test - Y_pred_DT) / np.var(Y_test)))
print("VAF: ",VAF)
nse_lr = 1 - ( np.sum((Y_test - Y_pred_DT)**2) / np.sum((Y_test - mean_observed)**2))
print("NSE: ",nse_lr)
...
print('SD: ',std_gbr)
VAF = 100 * (1 - (np.var(Y_test - Y_pred_GBR) / np.var(Y_test)))
print("VAF: ",VAF)
nse_lr = 1 - ( np.sum((Y_test - Y_pred_GBR)**2) / np.sum((Y_test - mean_observed)**2))
print("NSE: ",nse_lr)
...
print('SD: ',std_mlp)
VAF = 100 * (1 - (np.var(Y_test - Y_pred_MLP) / np.var(Y_test)))
print("VAF: ",VAF)
nse_lr = 1 - ( np.sum((Y_test - Y_pred_MLP)**2) / np.sum((Y_test - mean_observed)**2))
print("NSE: ",nse_lr)
