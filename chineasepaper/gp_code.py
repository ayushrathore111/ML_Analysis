...
residue_et = Y_test-y_pred_extra_trees
...
residue_br =Y_test-y_pred_bagging
...
residue_ar = Y_test-y_pred_adaboost
...
residue_xg = Y_test-y_pred
std_xg = np.std(residue_xg)
